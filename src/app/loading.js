export default function Loading() {
	return (
		<main>
			<div className="flex items-center gap-10 p-4 md:my-6 md:max-w-[65ch] md:mx-auto bg-white dark:bg-zinc-900 md:rounded border border-zinc-200 dark:border-zinc-800 dark:border-t-zinc-600">
				{[...Array(3)].map((_, i) => (
					<span
						key={i}
			...
			<div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 dark:border-t-zinc-600 md:rounded mb-6 md:max-w-[65ch] md:mx-auto divide-y divide-zinc-200 dark:divide-zinc-800">
				{[...Array(20)].map((_, i) => (
					<div
						key={i}
